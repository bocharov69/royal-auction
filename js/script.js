document.addEventListener('DOMContentLoaded', function () {
    ...
    if (barchart) {
        ...
        var barchartLegend = document.querySelector(".barchart-heading-legend");
        var barchartTotal = document.querySelector(".barchart-heading-total-span");
        var nav_select = document.querySelector('.barchart-nav-select');
        var nav_radio_labels = document.querySelectorAll('.barchart-nav-radio-label');
        ...
        function drawBarChart() {
            ...
            xAxis.style.backgroundColor = 'rgba(255,255,255,0.2)';
            ...
            yAxis.style.backgroundColor = 'rgba(255,255,255,0.2)';
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                yTick.style.color = 'rgba(255,255,255,0.2)';
                ...
                yTick_line.style.backgroundColor = 'rgba(255,255,255,0.2)';
