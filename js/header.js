...
<header>
    <nav>
        <ul class="header__menu">
            ...
            <li class="header__menu-item-wrapper">
                <a href="notifications.html" class="header__menu-item tooltip is-unread"
                    id="header__menu-link--notifications">
                    <div class="tooltip-text">
                        <div class="tooltip-content">
                            <div class="tooltip-notification is-unread">
                                <div class="tooltip-notification-img tooltip-notification-awardimg">
                                    <p class="tooltip-notification-awardimg-name">iPhone 12 128Gb</p>
                                    <img src="./img/awards/iphone12.png" alt="">
                                </div>
                                <div class="tooltip-notification-text">
                                    <p class="tooltip-notification-title">Lorem Ipsum</p>
                                    <p class="tooltip-notification-date">22/02/2023  23:34</p>
                                </div>
